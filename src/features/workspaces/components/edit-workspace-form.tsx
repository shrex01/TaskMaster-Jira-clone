...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
  ...
  return (
    <div className="flex flex-col gapy-y-4">
      <DeleteDialog />
      <ResetDialog />
                        ...
                        <div className="flex items-center gap-x-5">
                          ...
                          <div className="flex flex-col">
                            ...
                            <p className="text-sm text-muted-foreground">
                              JPG, PNG, SVG, GIF, or JPEG under 1mb
                            </p>
                            <input
                              type="file"
                              className="hidden"
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4">
              <div className="flex items-center gap-x-2">
                ...
                <Button className="size-12" onClick={handleCopyInviteLink} variant="secondary">
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Deleting a workspace is irreversible action and will remove all associated data.
            </p>
            <DottedSeparator className="py-7" />
            <Button
              className="mt-6 w-fit ml-auto"
